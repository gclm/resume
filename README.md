...
1. 开发业务接口，编写逻辑代码，与测试、前端合作。完成项目
2. 曾独立负责稳定性监控平台开发、作为核心人员参与Python加密的调研、项目实施、性能优化等全流程设计
3. 参与项目：稳定性监控平台、Python加密、产品性能优化方案设计和实现、灰度发布
4. 在校招新员工定级评价名列前茅
 ...
 **开发环境**：Python、Go、Shell、Telegraf、InfluxDB、grafana

 **技术细节**：

- 使用Python、Go、Shell 编写指标监控插件，使用Telegraf进行统一调度、把检查数据插入到InfluxDB中
- 使用grafana读取InfluxDB
...
我是一个双非毕业的本科生，我学历或许比其他求职者低，但是我很热爱编程、热爱技术，工作和学习期间曾比谁都努力过，有丰富的项目实战经验，如果可以的话希望可以阅读以下我的简历，给彼此一个机会。
